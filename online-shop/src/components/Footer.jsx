...
const Footer = () => {
  return (
    <footer className="text-gray-400 relative overflow-hidden text-xs bg-gray-900 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-2">
              < ShoppingBag size={32} className="text-[#4CAFFF] animate-pulse" />
            ...
            <p className="text-[#AAB4CE] hover:text-gray-300 transition-colors duration-300">
              Discover the best products and deals. Your shopping journey starts here.
            </p>
          </motion.div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Sale Items", "Women", "Men", "Electronics"].map((item) => (
                <motion.li
                  key={item}
                  whileHover={{ x: 5 }}
                  transition={{ duration: 0.3 }}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                {
                  icon: Mail,
                  text: "info@ashwaoshop.com",
                  href: "mailto:info@ashwaoshop.com",
                },
                {
                  icon: Phone,
                  text: "+1 (234) 567-890",
                ...
                { icon: MapPin, text: "Shop Center, Earth" },
              ].map((item, index) => (
                <motion.li
                  key={index}
                  whileHover={{ y: -3 }}
        ...
        <div className="mt-12 pt-8 border-t border-[#1A2D46]">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-[#AAB4CE] text-sm hover:text-gray-300 transition-colors duration-300">
              © {new Date().getFullYear()} AshwaoShop. All rights reserved.
            </div>
          </div>
        </div>
      </div>
